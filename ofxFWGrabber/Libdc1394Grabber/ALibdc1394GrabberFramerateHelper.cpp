/*
 *  ALibdc1394GrabberFramerateHelper.cpp
 *  SDL OpenGL Template
 *
...
dc1394framerate_t ALibdc1394GrabberFramerateHelper::numToDcLibFramerate( int rateNum  )
{
...
string ALibdc1394GrabberFramerateHelper::DcLibFramerateToString( dc1394framerate_t _framerate )
{
	switch ( _framerate )
	{
		...
		default:
			return "** ALibdc1394GrabberFramerateHelper::DcLibFramerateToString, unknown frame rate ";
			break;
