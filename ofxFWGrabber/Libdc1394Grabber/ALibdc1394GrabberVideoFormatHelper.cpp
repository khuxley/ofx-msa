/*
 *  ALibdc1394GrabberVideoFormatHelper.cpp
 *  SDL OpenGL Template
 *
...
dc1394video_mode_t  ALibdc1394GrabberVideoFormatHelper::videoFormatFromParams( int _width, int _height, int _vidFormat, bool _forceColor )
{
...
dc1394video_mode_t  ALibdc1394GrabberVideoFormatHelper::videoFormatFromParams160x120( int _vidFormat, bool _forceColor )
{
	return DC1394_VIDEO_MODE_160x120_YUV444;
}

dc1394video_mode_t  ALibdc1394GrabberVideoFormatHelper::videoFormatFromParams320x240( int _vidFormat, bool _forceColor )
{
	return DC1394_VIDEO_MODE_320x240_YUV422;
}

dc1394video_mode_t  ALibdc1394GrabberVideoFormatHelper::videoFormatFromParams640x480( int _vidFormat, bool _forceColor )
{
...
dc1394video_mode_t  ALibdc1394GrabberVideoFormatHelper::videoFormatFromParams800x600( int _vidFormat, bool _forceColor )
{
...
dc1394video_mode_t  ALibdc1394GrabberVideoFormatHelper::videoFormatFromParams1024x768( int _vidFormat, bool _forceColor )
{
...
dc1394video_mode_t  ALibdc1394GrabberVideoFormatHelper::videoFormatFromParams1280x960( int _vidFormat, bool _forceColor )
{
...
dc1394video_mode_t  ALibdc1394GrabberVideoFormatHelper::videoFormatFromParams1600x1200( int _vidFormat, bool _forceColor )
{
...
int ALibdc1394GrabberVideoFormatHelper::libcd1394ColorFormatToVidFormat(  uint32_t _colorFormatID )
{
